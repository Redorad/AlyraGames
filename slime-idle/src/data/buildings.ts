...
export const BUILDINGS: ShopItemDef[] = [
  ...
  // Endgame
  { id: "void_nexus", name: "Void Nexus", emoji: "🕳️", description: "+12M/s — Gateway to nothing", baseCost: 1e13, passivePower: 12_000_000 },
  { id: "star_forge", name: "Star Forge", emoji: "⭐", description: "+80M/s — Forge stars themselves", baseCost: 1e16, passivePower: 80_000_000 },
  { id: "reality_engine", name: "Reality Engine", emoji: "⚙️", description: "+600M/s — Generate universes", baseCost: 1e20, passivePower: 600_000_000 },
  { id: "omniplex", name: "The Omniplex", emoji: "🔆", description: "+5B/s — Center of everything", baseCost: 1e24, passivePower: 5_000_000_000 },
];
