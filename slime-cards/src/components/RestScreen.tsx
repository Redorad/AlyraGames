  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-navy-900 px-4">
      <div className="text-center slide-up">
        ...
        <h2 className="text-xl font-bold text-orange-400 mb-2">Feu de Camp</h2>
        <p className="text-gray-400 text-sm mb-6">Tu te reposes au coin du feu...</p>
        ...
        <div className="space-y-3">
          ...
          >
            {"\u{2764}\u{FE0F}"} Se reposer (+{healAmount} PV {"\u2192"} {newHp})
          </button>
        </div>
      </div>
    </div>
